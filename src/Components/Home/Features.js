    ...
    <>
      <section className="text-gray-400 bg-gray-900 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">
            Like It ? <h1 className="animate-pulse ml-2">❤</h1>
          </button>
        </div>
      </section>
    </>
